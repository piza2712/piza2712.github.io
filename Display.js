...
function obtenerFraseAlAzar() {
    ...
    calcular() {
      ...
      switch (this.tipoOperacion) {
        case 'sumar':
          ...
          // Mostrar mensaje utilizando la nueva función
          this.mostrarMensaje(fraseAnidadaAleatoria);
          break;
        ...
        case 'restar':
          ...
          // Mostrar mensaje utilizando la nueva función
          this.mostrarMensaje(fraseAnidadaAleatoria1);
          break;
        ...
        case 'multiplicar':
          ...
          // Mostrar mensaje utilizando la nueva función
          this.mostrarMensaje(fraseAnidadaAleatoria2);
          break;
        ...
        case 'dividir':
          ...
          // Mostrar mensaje utilizando la nueva función
          this.mostrarMensaje(fraseAnidadaAleatoria3);
          break;
      }
    }
  
    // Nueva ubicación de la función mostrarMensaje
  ...
  // ... (Código posterior que ya tenías) ...
